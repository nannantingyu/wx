...
class GiftbgController extends Controller {
    public function index(){
        ...
        $giftbg = M('giftcard_senduser')
            ...
            ->where(array('openid'=>session('openid'),'tj_samplenum'=>I('get.sampleno')))
    ...
    public function getgene($sampleno) {
        $sql = "select elephant_zi.geneName, elephant_zi.rsNo, elephant_zi.geneType, elephant_zi.personRisk from elephant_zi, (select klf,aldh,nos from elephant_zhu where sampleNo='100100100')g ".

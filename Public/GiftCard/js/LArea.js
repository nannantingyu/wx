...
window.LArea = (function() {
    ...
    MobileArea.prototype = {
        init: function(params) {
            ...
            this.form_ctrl = document.querySelector(params.form_ctrl);
            if(params.valueTo){
        ...
        finish: function(e) {
            ...
            val = provinceText + ((cityText)?(',' + cityText):(''))+ ((countyText)?(',' + countyText):(''));
            if("value" in _self.trigger) {
                _self.trigger.value = val;
            }
            else {
                _self.trigger.innerText = val;
            }

            _self.form_ctrl.value = val;
